...
namespace Projeto
{
    public class Publicador
    {
        ...
        public Publicador(string id, int port, string url, string site)
        {
            this.id = id;
            this.port = port;
            this.url = url;
...
public class Subscritor
{
    ...
    public Subscritor(string id, int port, string url, string site)
    {
        this.id = id;
        this.port = port;
        this.url = url;
...
public class Broker
{
    ...
    public Broker(string id, int port, string url, string site)
    {
        this.id = id;
        this.port = port;
        this.url = url;
